...
## 🛠️ Skills Demonstrated Across This Portfolio
...
- **String Methods** — `.lower()`, `.strip()`, and other sanitization techniques
- **Control Flow** — structuring programs that respond dynamically to user choices
...
1. Make sure Python 3 is installed on your machine. Check by running:
   ```bash
   python --version
   ```
...
3. Navigate into the project folder:
   ```bash
   cd python-portfolio/spy-detective-game
   ```
4. Run the script:
   ```bash
